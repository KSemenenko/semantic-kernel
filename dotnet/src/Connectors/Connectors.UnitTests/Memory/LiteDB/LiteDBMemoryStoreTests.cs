...
using Microsoft.SemanticKernel.Connectors.Memory.LiteDB;
using Microsoft.SemanticKernel.Memory;
using Xunit;

namespace SemanticKernel.Connectors.UnitTests.Memory.LiteDB;

/// <summary>
/// Unit tests of <see cref="LiteDBMemoryStore"/>.
/// </summary>
[Collection("Sequential")]
public class LiteDBMemoryStoreTests : IDisposable
{
    private const string DatabaseFile = "LiteDBMemoryStoreTests.db";
    private bool _disposedValue = false;

    public LiteDBMemoryStoreTests()
    {
    ...
    {
        using LiteDBMemoryStore db = await LiteDBMemoryStore.ConnectAsync(DatabaseFile);
        // Assert
        Assert.NotNull(db);
    }
